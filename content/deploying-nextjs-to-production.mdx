...
{/*
  content/blog/deploying-nextjs-to-production.mdx
  ─────────────────────────────────────────────────────────────────────────────
  Phase 5 — The actual blog post.
  All components used here (<Callout>, <PhaseHeading>, <CommandLine>) are
  registered globally in mdx-components.tsx — no import needed.
  Code blocks use rehype-pretty-code for syntax highlighting automatically.
*/}
